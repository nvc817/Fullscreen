...
DECLARE
    ...
    v_min_bytes    CONSTANT NUMBER := 10 * 1024 * 1024;   -- 10MB in bytes (minimum safe size)
    v_sql          VARCHAR2(1000);
BEGIN
    FOR r IN (
        ...
        WHILE NOT v_done LOOP
            BEGIN
                ...
                IF v_new_size < v_min_bytes THEN
                    DBMS_OUTPUT.PUT_LINE('Reached minimum size threshold. Skipping resize.');
                    v_done := TRUE;
                ELSE
